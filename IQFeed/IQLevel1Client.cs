...
namespace IQFeed
{
    ...
    public class Level1SummaryUpdateEventArgs : System.EventArgs
    {
        ...
        public Level1SummaryUpdateEventArgs(string line)
        {
            ...
            {
                case "t": _updateType = UpdateType.Trade; break;
                case "T": _updateType = UpdateType.ExtendedTrade; break;
                case "b": _updateType = UpdateType.Bid; break;
                case "a": _updateType = UpdateType.Ask; break;
                default: _updateType = UpdateType.Other; break;
            }
    ...
    public class IQLevel1Client : SocketClient, IList<IQLevel1WatchItem>
    {
        ...
        public IQLevel1WatchItem this[int index]
        {
            get
            {
        ...
        public IQLevel1WatchItem this[string symbol]
        {
            get { return _watchList[_key[symbol]]; }
        }
